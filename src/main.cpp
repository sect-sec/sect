...
int64 nChainStartTime = 1520589513;
...
const string strMessageMagic = "sharingecologicaltradechain Signed Message:\n";
...
bool CBlock::ConnectBlock(CTxDB& txdb, CBlockIndex* pindex, bool fJustCheck)
{
    ...
    bool fEnforceBIP30 = true; // Always active in sharingecologicaltradechain
    bool fStrictPayToScriptHash = true; // Always active in sharingecologicaltradechain
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "sharingecologicaltradechain", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "CBigNum vector sharingecologicaltradechain empty mapBlockIndex sharingecologicaltradechain sharingecologicaltradechain";
        CTransaction txNew;
        ...
        block.nNonce   = !fTestNet ? 27172473 : 279540;
       ...
       // printf("block.nNonce = %u \n", block.nNonce);
		block.print();
        assert(block.hashMerkleRoot == uint256("0x1f39178fcd46f1edc724d117ce9fe0eeb0a4f04e1de7afad54e53f36a8d34fb6"));
...
unsigned char pchMessageStart[4] = { 0x24, 0x85, 0x68, 0x36 };
